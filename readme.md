...
+ [`chrome-rpc`](https://github.com/fabiospampinato/chrome-rpc) ![][P] ![][DDD] ![][CHROME] : A simple RPC mechanism for Chrome extensions.
...
+ [`isotimer`](https://github.com/fabiospampinato/isotimer) ![][PP] ![][D] ![][ISO] ![][TREE] : An isomorphic setImmediate/setInterval/setTimeout implementation.
...
+ [`picolru`](https://github.com/fabiospampinato/picolru) ![][PP] ![][D] ![][ISO] : A tiny LRU implementation that strives for simplicity and performance.
...
+ [`regexp-get-prefix`](https://github.com/fabiospampinato/regexp-get-prefix): ![PP] ![][D] ![][ISO] : A function that extracts the set of possible first consumed characters from a regular expression.
...
+ [`vscode-ascii-tree`](https://github.com/fabiospampinato/vscode-ascii-tree) ![][P] ![][DDD] : An extension that provides the `ascii-tree` language, for enhancing ASCII trees.
...
+ [`vscode-cloner`](https://github.com/fabiospampinato/vscode-cloner) ![][PP] ![][DDD] : Duplicate a file or a directory with ease.
...
+ [`vscode-highlight`](https://github.com/fabiospampinato/vscode-highlight) ![][PP] ![][DDD] : Advanced text highlighter based on regexes. Useful for todos, annotations etc.
...
+ [`vscode-open-in-node-modules`](https://github.com/fabiospampinato/vscode-open-in-node-modules) ![][PP] ![][DDD] : Open the current selection or arbitrary string in node_modules.
